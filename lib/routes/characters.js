...
// //new routes to test ensureRole
//     .post('/admin', ensureRole('admin'), bodyParser, (req, res, next) => {
//         new Character(req.body).save()
//             .then(saved => res.send(saved))
//             .catch(next);
//     })

//     .put('/admin/:id', ensureRole('admin'), bodyParser, (req, res, next) => {
//         Character.findByIdAndUpdate(req.params.id, req.body, { new: true })
//             .then(saved => res.send(saved))
//             .catch(next);
//     })

//     .delete('/admin/:id', ensureRole('admin'), (req, res, next) => {
//         Character.findByIdAndRemove(req.params.id)
//             .then(deleted => res.send(deleted))
//             .catch(next);
//     });
